...
| Neon | Postgres | Launch (since 2026-09-12) | usage based: $0.106 per CU-hour while awake (sleeps after 5 min idle), $0.35 per GB-month storage, $0.20 per GB-month history; expect a few dollars a month at this size | 7 day history window and daily snapshots are enabled; the bill grows with database size and hours awake. |

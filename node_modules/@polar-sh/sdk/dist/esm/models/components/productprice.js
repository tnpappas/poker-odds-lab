...
import { ProductPriceSeatBased$inboundSchema, ProductPriceSeatBased$outboundSchema, } from "./productpriceseatbased.js";
/** @internal */
export const ProductPrice$inboundSchema = z.union([
    ...
    ProductPriceSeatBased$inboundSchema.and(z.object({ amount_type: z.literal("seat_based") }).transform((v) => ({
        amountType: v.amount_type,
    }))),
...
export const ProductPrice$outboundSchema = z.union([
    ...
    ProductPriceSeatBased$outboundSchema.and(z.object({ amountType: z.literal("seat_based") }).transform((v) => ({
        amount_type: v.amountType,
    }))),

...
export type SubscriptionUpdate = SubscriptionUpdateProduct | SubscriptionUpdateDiscount | SubscriptionUpdateTrial | SubscriptionCancel | SubscriptionRevoke;
/** @internal */
export declare const SubscriptionUpdate$inboundSchema: z.ZodType<SubscriptionUpdate, z.ZodTypeDef, unknown>;
/** @internal */
export type SubscriptionUpdate$Outbound = SubscriptionUpdateProduct$Outbound | SubscriptionUpdateDiscount$Outbound | SubscriptionUpdateTrial$Outbound | SubscriptionCancel$Outbound | SubscriptionRevoke$Outbound;
/** @internal */

...
/** @internal */
export const CountryAlpha2$outboundSchema = CountryAlpha2$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CountryAlpha2$;
(function (CountryAlpha2$) {
    /** @deprecated use `CountryAlpha2$inboundSchema` instead. */
    CountryAlpha2$.inboundSchema = CountryAlpha2$inboundSchema;
    /** @deprecated use `CountryAlpha2$outboundSchema` instead. */
    CountryAlpha2$.outboundSchema = CountryAlpha2$outboundSchema;

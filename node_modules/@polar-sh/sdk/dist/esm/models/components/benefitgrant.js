...
/** @internal */
export const Properties$inboundSchema = z.union([
...
(function (Properties$) {
    ...
    Properties$.inboundSchema = Properties$inboundSchema;
    /** @deprecated use `Properties$outboundSchema` instead. */
    Properties$.outboundSchema = Properties$outboundSchema;
...
/** @internal */
export const BenefitGrant$inboundSchema = z.object({
...
/** @internal */
export const BenefitGrant$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var BenefitGrant$;
(function (BenefitGrant$) {
    /** @deprecated use `BenefitGrant$inboundSchema` instead. */
    BenefitGrant$.inboundSchema = BenefitGrant$inboundSchema;
    /** @deprecated use `BenefitGrant$outboundSchema` instead. */
    BenefitGrant$.outboundSchema = BenefitGrant$outboundSchema;
})(BenefitGrant$ || (BenefitGrant$ = {}));
export function benefitGrantToJSON(benefitGrant) {
    return JSON.stringify(BenefitGrant$outboundSchema.parse(benefitGrant));
}
export function benefitGrantFromJSON(jsonString) {
    return safeParse(jsonString, (x) => BenefitGrant$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'BenefitGrant' from JSON`);
}

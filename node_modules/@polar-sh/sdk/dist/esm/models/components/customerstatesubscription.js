...
import { CustomerStateSubscriptionMeter$inboundSchema, CustomerStateSubscriptionMeter$outboundSchema, } from "./customerstatesubscriptionmeter.js";
...
/** @internal */
export const CustomerStateSubscriptionMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
export const CustomerStateSubscriptionMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
...
/** @internal */
export const CustomerStateSubscriptionStatus$inboundSchema = z.nativeEnum(CustomerStateSubscriptionStatus);
/** @internal */
export const CustomerStateSubscriptionStatus$outboundSchema = CustomerStateSubscriptionStatus$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var CustomerStateSubscriptionStatus$;
...
})(CustomerStateSubscriptionStatus$ || (CustomerStateSubscriptionStatus$ = {}));
/** @internal */

...
const customersGetBalance_js_1 = require("../funcs/customersGetBalance.js");
...
class Customers extends sdks_js_1.ClientSDK {
    ...
    async getBalance(request, options) {
        return (0, fp_js_1.unwrapAsync)((0, customersGetBalance_js_1.customersGetBalance)(this, request, options));
    }
}

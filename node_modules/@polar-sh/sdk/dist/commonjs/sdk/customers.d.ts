...
export declare class Customers extends ClientSDK {
     ...
     * **Scopes**: `customers:read` `customers:write`
     */
    export(request: CustomersExportRequest, options?: RequestOptions): Promise<any>;
    /**
     * Get Customer
     *
     * @remarks
     ...
     * **Scopes**: `customers:read` `customers:write`
     */
    getBalance(request: CustomersGetBalanceRequest, options?: RequestOptions): Promise<CustomerBalance>;
}

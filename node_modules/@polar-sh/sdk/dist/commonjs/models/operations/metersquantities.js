...
const aggregationfunction_js_1 = require("../components/aggregationfunction.js");
...
exports.MetersQuantitiesRequest$inboundSchema = z.object({
    ...
    external_customer_id: z.nullable(z.union([z.string(), z.array(z.string())]))
        .optional(),
    customer_aggregation_function: z.nullable(aggregationfunction_js_1.AggregationFunction$inboundSchema)
        .optional(),
...
exports.MetersQuantitiesRequest$outboundSchema = z.object({
    ...
    externalCustomerId: z.nullable(z.union([z.string(), z.array(z.string())]))
        .optional(),
    customerAggregationFunction: z.nullable(aggregationfunction_js_1.AggregationFunction$outboundSchema)
        .optional(),

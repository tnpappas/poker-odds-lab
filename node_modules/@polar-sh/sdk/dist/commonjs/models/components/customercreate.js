...
/** @internal */
exports.CustomerCreateMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
exports.CustomerCreateMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
...
exports.CustomerCreate$inboundSchema = z.object({
    ...
    billing_address: z.nullable(addressinput_js_1.AddressInput$inboundSchema).optional(),
...
exports.CustomerCreate$outboundSchema = z.object({
    ...
    email: z.string(),
    name: z.nullable(z.string()).optional(),
    billingAddress: z.nullable(addressinput_js_1.AddressInput$outboundSchema).optional(),

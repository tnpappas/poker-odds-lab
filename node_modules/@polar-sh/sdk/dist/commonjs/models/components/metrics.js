...
exports.Metrics$inboundSchema = z.object({
    ...
    canceled_subscriptions: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_customer_service: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_low_quality: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_missing_features: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_switched_service: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_too_complex: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_too_expensive: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_unused: metric_js_1.Metric$inboundSchema,
    canceled_subscriptions_other: metric_js_1.Metric$inboundSchema,
}).transform((v) => {
...
exports.Metrics$outboundSchema = z.object({
    ...
    canceledSubscriptions: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsCustomerService: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsLowQuality: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsMissingFeatures: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsSwitchedService: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsTooComplex: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsTooExpensive: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsUnused: metric_js_1.Metric$outboundSchema,
    canceledSubscriptionsOther: metric_js_1.Metric$outboundSchema,
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {

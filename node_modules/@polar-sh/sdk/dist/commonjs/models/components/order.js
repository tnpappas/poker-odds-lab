...
const ordercustomer_js_1 = require("./ordercustomer.js");
...
/** @internal */
exports.OrderMetadata$inboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/** @internal */
exports.OrderMetadata$outboundSchema = z.union([z.string(), z.number().int(), z.number(), z.boolean()]);
/**
 * @internal
...
/** @internal */
exports.OrderCustomFieldData$inboundSchema = z.union([
    z.string(),
    z.number().int(),
    z.boolean(),
...
/** @internal */
exports.OrderCustomFieldData$outboundSchema = z.union([
    z.string(),
    z.number().int(),
    z.boolean(),
...
exports.Order$inboundSchema = z
    ...
    customer: ordercustomer_js_1.OrderCustomer$inboundSchema,
    user_id: z.string(),
...
exports.Order$outboundSchema = z.object({
    ...
    customer: ordercustomer_js_1.OrderCustomer$outboundSchema,
    userId: z.string(),

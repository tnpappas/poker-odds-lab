...
import { CustomerStateSubscriptionMeter, CustomerStateSubscriptionMeter$Outbound } from "./customerstatesubscriptionmeter.js";
...
export type CustomerStateSubscriptionMetadata = string | number | number | boolean;
export declare const CustomerStateSubscriptionStatus: {
    readonly Active: "active";
    readonly Trialing: "trialing";
};
export type CustomerStateSubscriptionStatus = ClosedEnum<typeof CustomerStateSubscriptionStatus>;
/**
...
/** @internal */
export type CustomerStateSubscriptionMetadata$Outbound = string | number | number | boolean;
/** @internal */
...
/** @internal */
export declare const CustomerStateSubscriptionStatus$inboundSchema: z.ZodNativeEnum<typeof CustomerStateSubscriptionStatus>;
/** @internal */
export declare const CustomerStateSubscriptionStatus$outboundSchema: z.ZodNativeEnum<typeof CustomerStateSubscriptionStatus>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace CustomerStateSubscriptionStatus$ {

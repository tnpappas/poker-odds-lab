...
import { ProductPriceSeatBasedCreate, ProductPriceSeatBasedCreate$Outbound } from "./productpriceseatbasedcreate.js";
...
export type Two = (ProductPriceMeteredUnitCreate & {
...
export type ProductUpdatePrices = ExistingProductPrice | (ProductPriceMeteredUnitCreate & {
    amountType: "metered_unit";
}) | (ProductPriceFixedCreate & {
    amountType: "fixed";
}) | (ProductPriceSeatBasedCreate & {
...
export type ProductUpdate = {
     ...
     */
    prices?: Array<ExistingProductPrice | (ProductPriceMeteredUnitCreate & {
        amountType: "metered_unit";
    }) | (ProductPriceFixedCreate & {
        amountType: "fixed";
    }) | (ProductPriceSeatBasedCreate & {
...
/** @internal */
export type Two$Outbound = (ProductPriceMeteredUnitCreate$Outbound & {
...
/** @internal */
export type ProductUpdatePrices$Outbound = ExistingProductPrice$Outbound | (ProductPriceMeteredUnitCreate$Outbound & {
    amount_type: "metered_unit";
}) | (ProductPriceFixedCreate$Outbound & {
    amount_type: "fixed";
}) | (ProductPriceSeatBasedCreate$Outbound & {
...
export type ProductUpdate$Outbound = {
    ...
    prices?: Array<ExistingProductPrice$Outbound | (ProductPriceMeteredUnitCreate$Outbound & {
        amount_type: "metered_unit";
    }) | (ProductPriceFixedCreate$Outbound & {
        amount_type: "fixed";
    }) | (ProductPriceSeatBasedCreate$Outbound & {

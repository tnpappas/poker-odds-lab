...
export const TOOL_HELP: ToolHelp[] = [
  {
    ...
    what: 'A poker hand plays out one step at a time. At each big decision it pauses and asks you to read your opponent, then choose call, fold, or raise.',
    steps: [
      'Watch the hand deal out. When it pauses, look at the pot size, your cards, and how much you have to pay to stay in.',
      'You will see a grid of all 169 possible starting hands (pairs run down the middle, and an "s" means suited, an "o" means offsuit). Tap or drag to paint the hands you think your opponent could be holding. That is your read.',
      'As you paint, the app instantly shows your equity (your chance to win) against that exact read, right next to the equity you would need for calling to be worth it.',
      'Pick call, fold, or raise. The app then reveals your opponent’s real hand, scores how close your read was, and explains the right play in plain language.',
      'You earn points for good decisions and accurate reads, not for winning the pot, so you are rewarded for thinking correctly even when the cards do not cooperate.',
    ],
    learn: 'How to put an opponent on a range and turn that read into the mathematically correct call, fold, or raise, and why it is correct.',
  },
  {
    path: '/visualizer',
